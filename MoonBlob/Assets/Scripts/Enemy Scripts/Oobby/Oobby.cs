...
public class Oobby : Enemy
{
    ...
    protected override void Shoot()
    {
        ...
        secondBullet.Initialize(this, entityData.bulletDamage, entityData.bulletSpeed, entityData.bulletLifeTime, secondGun.transform, false);
    }

    protected override void Die()
    {
        // Spawn 2 Globs on death
        StateManager.instance.dataDB.enemyPrefabs.TryGetValue("Glob", out GameObject globPrefrab);
        if (globPrefrab != null)
        {
            int globCount = 2;
